class JobsController < ApplicationController
	...
	def puc_validados
			if current_user.admin? 
				...
				@jobs = Job.where("(category_id = 3 or category_id = 4 or category_id = 8 or category_id = 16 or category_id = 21 or category_id = 27 or category_id = 31 or category_id = 35 or category_id = 49 or category_id = 60 or category_id = 61 ) and situacao = 'validado'  ").paginate(page: params[:page], per_page:5)  
			elsif current_user.try(:gestorMQ? ) # Metodos 
				@jobs = Job.where("(category_id = 5 or category_id = 9 or category_id = 15 or category_id = 26 or category_id = 39) and situacao = 'validado'   ").paginate(page: params[:page], per_page:5)  
			elsif current_user.try(:gestorEG? ) # economia e Gestão 
